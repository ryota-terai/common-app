...
map.on('load', function () {
    ...
    map.addSource('shelter_point', {
        type: 'geojson',
        data: '/COMMONApp/webresources/rest/shelterInfo?areaCode=' + areaCode + '&P20_007=true&P20_008=true&P20_009=true&P20_010=true&P20_011=true&open=false'
    });
    map.loadImage(
            './img/shelter.png',
    ...
    map.addSource('shelter_open_point', {
        type: 'geojson',
        data: '/COMMONApp/webresources/rest/shelterInfo?areaCode=' + areaCode + '&P20_007=true&P20_008=true&P20_009=true&P20_010=true&P20_011=true&open=true'
    });
    map.loadImage(
    ...
    map.addSource('disaster', {
        type: 'geojson',
        data: '/COMMONApp/webresources/rest/disasterInfo'
    });
...
map.on('click', 'disaster', function (e) {
    ...
    if (picture === true) {
        comment += '<br><iframe src=\"/COMMONApp/faces/post/view/picture.xhtml?id=' + id + '\" width="200" height="150"></iframe>';
        comment += '<br><a href=\"/COMMONApp/faces/post/view/view.xhtml?id=' + id + '\" target=\"_blank\">投稿情報画面で確認</a>';
    }
